...
[![My Skills](https://skillicons.dev/icons?i=react,redux,wordpress,typescript,js,html,css,vite,webpack,php,python,cpp,java,tailwind,sass,bootstrap,tailwind,emotion,nextjs,nodejs,express,mongodb,postgres,mysql,sequelize,postman,figma,git,github,bash,stackoverflow,pr,vscode,graphql,linux,md)](https://skillicons.dev)
